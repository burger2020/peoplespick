...
import picturePick.picture.main_user.profile_rating.bottom_menu_activity.Edit_adapter_gallary.Companion.click_photo_bitmap
...
class Select_ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
    ...
    fun bindHolder(context:Context, photo_url:ArrayList<Uri>,position: Int) {
        ...
        select_image.isDrawingCacheEnabled = false
        select_image.buildDrawingCache()
        click_photo_bitmap.add((select_image.drawingCache))
